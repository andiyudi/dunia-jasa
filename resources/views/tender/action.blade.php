...
<div class="d-grid gap-2 col-8 mx-auto">
    <a href="{{ route($route.'.edit', $encryptTenderId) }}" class="btn btn-sm btn-warning action icon icon-left">
        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
            <path d="M12 20h9"></path>
            <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>
        </svg>
    </a>
    <a href="{{ route($route.'.show', $encryptTenderId) }}" class="btn btn-sm btn-info action icon icon-left">
        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
    ...
    @else
        <button class="btn btn-sm btn-danger action icon icon-left remove-btn" data-bs-toggle="modal" data-bs-target="#removeModal-{{ $encryptTenderId }}" data-id="{{ $encryptTenderId }}">
            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                <polyline points="3 6 5 6 21 6"></polyline>
                <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
            </svg>
